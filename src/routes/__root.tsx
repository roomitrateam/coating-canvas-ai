...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Crown Detailing & Coating — Raleigh, NC" },
      { name: "author", content: "Crown Detailing & Coating" },
      { property: "og:site_name", content: "Crown Detailing & Coating" },
